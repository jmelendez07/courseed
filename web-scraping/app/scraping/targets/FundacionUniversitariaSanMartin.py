...
class FundacionUniversitariaSanMartin(BaseScraper):
    url = "https://sga-cloud.casewaresa.com/usm/sgacampus/services/cursos/fetch"
    INSTITUTION: str = "Fundación Universitaria San Martín"

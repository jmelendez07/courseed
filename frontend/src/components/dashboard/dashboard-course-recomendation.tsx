...
import { ArrowUpDown, DollarSign, Eye, LoaderCircle, MoreHorizontal, Star, Timer, Users } from "lucide-react";
...
function DashboardCourseRecomendation() {
    ...
    return (
        <AnimatePresence mode="popLayout">
            <motion.div 
                ...
                className={`grid grid-cols-1 h-full ${ loading ? 'place-items-center' : '' }`}
                        ...
                        <>
                            <div className="flex sm:items-center pb-4 flex-col gap-2 sm:flex-row sm:justify-between">
                                <div className="flex items-center">
                                    <h2 className="text-xl font-semibold">Todos los programas</h2>
                                </div>
                                <Input
...
export default DashboardCourseRecomendation;